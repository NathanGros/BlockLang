 ...
 * OrBlock
 */
public class OrBlock extends BooleanBlock {
    private BooleanSlot booleanSlot1;
    private BooleanSlot booleanSlot2;
    private static final String text = "or";
    private static Float CENTER_WIDTH = 40.f;

    public OrBlock(Float posX, Float posY) {
	...
	public void draw() {
        ...
        drawHexagon(getPosX(), getPosY(), width, height, Colors.getOperatorsBorderColor());
        drawHexagon(getPosX() + borderX, getPosY() + borderY, width - 2.f * borderX, height - 2.f * borderY, Colors.getOperatorsColor());
        drawText();
	}
